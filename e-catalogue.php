...
<head>
    <meta charset="UTF-8">
    <title>Sharptools || E-Catalogue</title>
                        ...
                        <ul class="navigation">
                         ...
                         <li><a href="blog.php">CSR</a></li>
						  <li><a href="store-locator.php">Store Locator</a></li>
							<li class="active"><a href="e-catalogue.php">E-Catalogue</a></li>
                        </ul>
                    </div>
                                        ...
                                        <div class="box">
										 <div class="top-box">
                                            ...
                                            <div class="bottom-box">
                                                <ul>                              											
													<li><a href="quick-view-product.php?id=<?php echo $product['id'] ?>" class="fancybox fancybox.ajax"><i class="fa fa-eye">  Quick view</i></a></li>
